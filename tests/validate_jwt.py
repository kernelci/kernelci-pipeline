...
def test1():
    ...
    email = "test@test.com"
    expected_token = (
        "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJwZXJtaXNzaW9ucyI6WyJjaGVja291dCIs"
        "InRlc3RyZXRyeSIsInBhdGNoc2V0Il0sImVtYWlsIjoidGVzdEB0ZXN0LmNvbSJ9."
        "aL-yk5WVZKbzhPbN28KhjRONaae_2dGxsknwCXvuIHI"
    )
    ...
    assert jwt_token == expected_token, (
        f"Expected {expected_token}, but got {jwt_token}"
    )
