...
class SetCompleted:
    ...
    def __init__(self, configs, args):
        ...
        self._logger = Logger("config/logger.conf", "set_completed")
...
completed"
    ...
    def __call__(self, configs, args):
        set_completed = SetCompleted(configs, args)
        set_completed.run()


if __name__ == '__main__':
    opts = parse_opts('set_completed', globals())
